            ...
            <div className="w-full max-w-4xl text-center px-6">
             ...
             duration-300 ease-in-out group">
               ...
               duration-300 ease-in-out group">
                    ...
                    <div className="flex flex-col items-center p-6 bg-gray-800 rounded-xl shadow-lg transform hover:scale-105 hover:bg-gray-500 hover:-translate-y-2 hover:border-indigo-700 border-2 border-transparent 
              ...
              transition-all duration-300 ease-in-out group">
                    ...
                    <div className="flex flex-col items-center p-6 bg-gray-800 rounded-xl shadow-lg  transform hover:scale-105 hover:bg-gray-600 hover:-translate-y-2 hover:border-indigo-700 border-2 border-transparent 
              transition-all duration-300 ease-in-out group">
                        <img
